  ...
  return (
    <article>
      <header className="card">
        <p className="eyebrow" style={{ marginTop: 0 }}>Atlas · Theme</p>
        <h1 style={{ marginTop: 0 }}>{slug.replaceAll('-', ' ')}</h1>
        <p className="small" style={{ marginBottom: 0 }}>
          Placeholder research record for theme navigation scaffolding.
        </p>
      </header>
      ...
      <section className="card" style={{ marginTop: '1rem' }}>
        ...
        <p>
          <Link href="/atlas/theme" className="nav-link">Back to theme browse</Link>
        </p>
      </section>
